...
{     
 ...
 #print "INSERT INTO t_trans_h (NIK,NOMINAL,STATUS,OPRCREATE $subkolom) VALUES
 #           ('$idlama','$in{nominal}','1','$s3s[0]' $subvalue );<br/> ";

       $flag = $dbk->do("
        INSERT INTO t_trans_h (NIK,NOMINAL,STATUS,OPRCREATE $subkolom) VALUES
            ('$idlama','$in{nominal}','1','$s3s[0]' $subvalue);");
