...
<center>
            ...
            <tr>
              ...
              <p><img src="/images/logo_siskop.jpg" /> </p>
              </td>
            </tr>~;
...
if (($in{vpc} ne '1.05') || (!$in{ipc})) {
  print qq~
           <tr>
              ...
              Untuk Login kembali harap keluar dan masuk kembali dari SISKOPERASI.</b></font></td>
           </tr>~;
} else {
  ...
  print qq~
            ...
            <tr>
              <td height="25" colspan="3" align="center" valign="middle" bgcolor=$dark class="menu1"><strong>LOGIN SISKOPERASI $subjdl</strong></td>
              </tr>
            ...
            <tr>
              ...
              <input name="pages" type="hidden" value="kop002" />
              </td>
            </tr>
            </form>
            <tr>
