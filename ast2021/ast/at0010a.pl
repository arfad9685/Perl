...
genfuncast::view_header($in{ss}, $s3s[2], 'Tambah Inventori');
...
#       if($s3s[0] eq 'XTIN')
#       { print qq~ INSERT INTO INVENTORI (KODE,JENIS,MEREK,KONDISI,KETERANGAN,FLAGASSET,NOSERI,IP,CURRCABANG,CURRIDLAMA,WARNA,KODELAMA,OS,COMPUTERNAME, OPRCREATE $subkolom) VALUES
