...
genfuncast::view_header($in{ss}, $s3s[2], 'Detail Inventori');
...
<tr bgcolor=$colcolor height=20>
    ...
    <td class="hurufcol" > $in{kd}  &nbsp;&nbsp; &nbsp;&nbsp; $ketgrup
    </td>
</tr>
...
<tr bgcolor=$colcolor height=20>
    ...
    <td class="hurufcol" > $record[2]    </td>
</tr>

<tr bgcolor=$colcolor height=20>
    <td class="hurufcol" width=120>&nbsp;Model / Tipe </td>
    <td class="hurufcol" > $record[4]    </td>
</tr>

<tr bgcolor=$colcolor height=20>
    <td class="hurufcol" width=120>&nbsp;Ukuran </td>
    <td class="hurufcol" > $record[5]    </td>
</tr>
...
<td class="hurufcol" >$record[7]</td>
</tr>

<tr bgcolor=$colcolor height=20>
    <td class="hurufcol" width=120>&nbsp;Keterangan </td>
    <td class="hurufcol" > $record[17]    </td>
</tr>

<tr bgcolor=$colcolor height=20>
   <td class="hurufcol">&nbsp;Tanggal Beli</td>
   <td class="hurufcol" > $record[18]    </td>
</tr>

<tr bgcolor=$colcolor height=20>
    <td class="hurufcol" width=120>&nbsp;Harga </td>
    <td class="hurufcol" > $record[19]    </td>
  </tr>

<tr bgcolor=$colcolor height=20>
    <td class="hurufcol">&nbsp;Nama Karyawan </td>
    <td class="hurufcol"> $record[12] - $record[11]
...
");
  ...
  if ($row[13] eq 'S'){
    print qq~<a class=huruflink href="sisasset.cgi?pages=at0017d&sid=$row[12]&ss=$in{ss}&from=at0010d&kd=$in{kd}">$row[1]</a> ~;}
  if ($row[13] eq 'T'){
    print qq~<a class=huruflink href="sisasset.cgi?pages=at0013d&rid=$row[12]&ss=$in{ss}&from=at0010d&kd=$in{kd}">$row[1]</a> ~;}
  print qq~
    </td>
...
while (@row = $q->fetchrow_array())
{
  ...
  <tr bgcolor=$colcolor height=20>
     ...
     <td align='left' class="hurufcol" valign='top'><a class=huruflink href="sisasset.cgi?pages=at0014d&rid=$row[15]&ss=$in{ss}&from=at0010d&kd=$in{kd}">$row[1]</a></td>
