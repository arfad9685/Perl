...
$query = $dba1->prepare("select dtkirim, nosurat,cabang_asal,c2.namacabang,  idlama_asal, h.printke, dthrskembali, cabang_tuj, c1.namacabang, h.ket
from kirimh h,kirimd d, getstruk c1, getstruk c2 where  h.cabang_tuj=c1.kodecabang and h.recid=d.kirimid and d.cabang_asal=c2.kodecabang
and h.recid='$in{recidprint}' ");
...
$isi = qq~
<center><h3 class=hurufprint>NOTA PENERIMAAN BARANG<br/> $reprint</h3></center>
    ...
    <tr class=hurufprint>
        ...
        <table cellpadding="2" cellspacing="0" width=600>
         <tr class=hurufprint>
          ...
          Penerima, <br/> <br/> <br/> <br/> <br/> (...............................)</td>
          <td align=center valign='top'>
          Mengetahui, <br/> <br/> <br/> <br/> <br/> (...............................)</td>
          <td align=center valign='top'>
          Pengirim, <br/> <br/> <br/> <br/> <br/> ($namakry)</td>
        </tr>
        </table>
        </td>
    </tr>
...
$htmldoc->set_page_size("21x15.8cm");
