...
if ($in{simpan}) {
  ...
  <script type="text/javascript">
   ...
   function tab_view1(data) {
	  ...
	  txt += "<th align='center' width=30>Toleransi Dev</th>";
	  ...
	  txt +="<input name=baris type='hidden' value="+x+">"; 	
		 txt +="<tr><th colspan=13 width=100% align=left></th><th colspan=2>Toleransi</th><th align=right style='text-align:right'>"+data[x].toleransi+"&nbsp;</th></tr>";	
