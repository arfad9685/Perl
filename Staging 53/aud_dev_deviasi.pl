 ...
 function chkmax (i)
  {var devaskhir = document.getElementById("devaskhir"+i).value;
   ...
   function tab_view1(data) {
	  ...
	  txt += "<th align='center' width=30>Tgl Opname Awal</th>";
     ...
     txt +="<input name=rc"+x+" type='hidden' value="+data[x].recid+">";        
	  ...
	  txt +="<tr><td colspan=5 width=100% align=center><input type=submit name=save class='button button_green' value=Save ></td></tr>";
      txt +="</tbody></table>";        
