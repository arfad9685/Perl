...
&con_ass0;
 ...
 # print $in{cab}.$in{nama};
   xml_module::view_table("ho/tb_dev_tes","ss=$in{ss}&cab=$in{cab}&tgl1=$in{tgl1}",1); #(script_view.pl, params, table cnt)
 }  
 ...
 if (index($rws,'S') ne (-1)) {
  ...
  <table width=1200 border=1 style="border-collapse: collapse;">
    <tr><td width=100%>
            <table width=100%>           
             <form method=GET>
             <input name="pages" type="hidden" value=aud_dev>
...
<script type="text/javascript">
   ...
   function tab_view1(data) {
	  ...
	  txt += "<th align='center' width=30>Retur WIP X FC</th>";
	  txt += "<th align='center' width=30>Retur FG X FC</th>";
      ...
      for (x in data) {
		   ...
		   txt += "<td align=right>&nbsp;"+data[x].wastekry+"</td><td align=right>"+data[x].wastegumpil+"&nbsp;</td>";
		   txt += "<td align=right>&nbsp;"+data[x].wastewipxfc+"</td><td align=right>"+data[x].wastefgxfc+"&nbsp;</td>";
		   txt += "<td align=right>&nbsp;"+data[x].returwipxfc+"</td><td align=right>"+data[x].returfgxfc+"&nbsp;</td>";
	  ...
	  txt += "<tr class=huruf2><td align=left>"+data[x].cab+"</td>";	
	  ...
	  txt += "<td align=right>"+data[x].totaldevxfc+"</td>";
	  txt += "<td align=right>"+data[x].devxfctotal+"</td>";
	  txt += "<td align=right>"+data[x].wastegumpil+"</td>";
	  txt += "<td align=right>"+data[x].wastewipxfc+"</td>";
	  txt += "<td align=right>"+data[x].wastefgxfc+"</td>";
	  txt += "<td align=right>"+data[x].returwipxfc+"</td>";
	  txt += "<td align=right>"+data[x].returfgxfc+"</td>";
	  txt += "<td align=right>"+data[x].totalauto+"</td>";
	  txt += "<td align=right>"+data[x].totaljml+"</td></tr>";
