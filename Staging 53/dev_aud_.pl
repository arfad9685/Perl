...
$strv="ss=$in{ss}&cab=$in{cab}&tgl1=$in{tgl1}&tgl2=$in{tgl2}";
 ...
 <script type="text/javascript"> 
   function tab_view1(data) {
      ...
      txt += "<thead>";
      txt += "<tr>";
      txt += "<th align='center' width=120>Kode Jenis</th>";
      ...
      for (x in data) {
		   ...
		   txt += "<td align=center>&nbsp;"+data[x].opn_date+"</td><td align=right>"+data[x].awal+"&nbsp;</td>";
		   txt += "<td align=right>&nbsp;"+data[x].jml_masuk+"</td><td align=right>"+data[x].jml_beli+"&nbsp;</td>";
		   txt += "<td align=right>&nbsp;"+data[x].jml_kirim+"</td><td align=right>"+data[x].waste+"&nbsp;</td>";	
		   ...
		   txt += "<td align=right><input style='width:100%' value='$harga' name='harga'>"+data[x].adjus+"</td><td align=right>"+data[x].devasli+"&nbsp;</td>";
           txt +="</tr>";     
      }
      txt +="</tbody></table>";        
